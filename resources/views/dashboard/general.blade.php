                    ...
                    <div class="card-body">
                        ...
                        <form action="/admin/general/{{ $general->id }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <img src="{{ asset('storage/' . $general->brand_navbar) }}"
                                        alt="{{ $general->brand_navbar }}" id="output">
                                </div>
                                <input class="form-control" @error('brand_navbar') is-invalid @enderror"
                                    value="{{ $general->brand_navbar }}" name="brand_navbar" type="file"
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" @error('background_footer') is-invalid @enderror"
                                        value="{{ $general->background_footer }}" name="background_footer" type="file"
                                        id="img" accept="image/*">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" @error('cursor_image') is-invalid @enderror"
                                                    value="{{ $general->cursor_image }}" name="cursor_image"
                                                    type="file" id="pre" accept="image/*""
                                                name=" cursor_image">
                                                @error('cursor_image')
                                                    <small class="text-danger">{{ $message }}</small>
                                                @enderror
