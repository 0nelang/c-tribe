    ...
    <div class="container pt-4">
        ...
        <div class="row">
            ...
            <div class="col-4 ml-auto mr-3 d-flex">
                ...
                <input id="total" class="form-control my-3 ml-2 col-9" style=" vertical-align: middle;" type="text"
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-check d-flex">
                                    <input type="text" value="{{ $s->price }}" name="price-{{ $s->id }}"
                                        id="price-{{ $s->id }}" onkeyup="onchange_comma(this.id, this.value)">
                                    <input onclick="checking({{ $s->id }})" class="ml-3"
                                        style="width: 30px; height:30px" type="checkbox" value="true"
                                        name="{{ $s->id }}" id="checked-{{ $s->id }}">
                                </div>
                            </td>
                        </tr>
                    @endforeach
        ...
        function price() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    var x = numeral(response).format('0,0');
                    $('#total').val('Rp ' + x);
                }
            });
        }
