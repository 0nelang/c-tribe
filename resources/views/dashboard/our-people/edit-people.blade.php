        ...
        <div class="row">
            <div class="col">
                <div class="card">
                    <div class="card-body">
                        <form
                            action="{{ route('people.update',['person' => $people->id]) }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                                    value="{{ $people->name }}" id="exampleInputEmail1"
                                    aria-describedby="our-people-name">
                                @error('name')
                            ...
                            <div class="mb-3">
                                ...
                                <br>
                                <img src="{{ asset('storage/' . $people->photo ) }}"
                                    id="output" class="mb-3" style="max-height: 200px; max-width: 200px;">
