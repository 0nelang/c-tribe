                        ...
                        <div class="card-body">
                            <form action="{{ route('project.update', ['project' => $project->id]) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3 col-lg-2 ps-3">
                                        ...
                                        <div class="d-flex pt-2 ">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="type" id="type1" value="project" {{ ($project->type === 'project')? 'checked' : ''  }}>
                                                <label class="form-check-label" for="type1">
                                                  project
                                                </label>
                                            </div>
                                            <div class="form-check ps-5">
                                                <input class="form-check-input" type="radio" name="type" id="type2" value="person" {{ ($project->type === 'person')? 'checked' : ''  }}>
                                ...
                                <div class="mb-3">
                                    ...
                                    class="form-control @error('subTitle') is-invalid @enderror editable" id="subTitle"
                                    >{{ $project->subTitle }}</textarea>
                                    @error('subTitle')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
